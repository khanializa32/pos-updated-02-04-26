...
@section('content')
    ...
    <section class="content-header">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('lang_v1.add_stock_transfer')
     ...
     <div class="modal-dialog">
        <div class="modal-content" style="padding-bottom: 40px">
            ...
            <div class="modal-body">
                ...
                <p id="description-tutorial">Realice traslados de mercancias</p>
        ...
        @component('components.widget', ['class' => 'box-solid'])
            ...
            <div class="row">
                ...
                <div class="col-sm-12 text-center">
                    <button type="submit" id="save_stock_transfer" class="tw-dw-btn tw-dw-btn-warning tw-dw-btn-lg tw-text-black">@lang('messages.save')</button>
                </div>
            </div>
        @endcomponent
