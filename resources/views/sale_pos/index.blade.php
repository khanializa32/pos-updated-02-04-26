                ...
                <!-- End Include filter for products according to rack -->
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <br>
                            <label>
                                {!! Form::checkbox('inventory_check', 1, false, ['class' => 'input-icheck', 'id' => 'inventory_check']) !!} <strong>Inventory Check</strong>
                            </label>
                        </div>
                    </div>
                    @if ($is_woocommerce)
...
@section('javascript')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            product_table = $('#product_table').DataTable({
                ...
                "ajax": {
                    ...
                    "data": function(d) {
                        ...
                        d.inventory_check = $('#inventory_check').is(':checked');
            ...
            $(document).on('ifChanged', '#not_for_selling, #woocommerce_enabled, #inventory_check', function() {
                if ($("#product_list_tab").hasClass('active')) {
                    product_table.ajax.reload();
                }
