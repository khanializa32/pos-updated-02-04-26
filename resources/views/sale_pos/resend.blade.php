...
@section('title', 'Reenviar correo de la factura')

@section('content')
<!-- Content Header (Page header) -->
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">Reenviar correo de la factura</h1>
</section>
<!-- Main content -->
...
@endphp
	...
	{!! Form::open(['url' => action([\App\Http\Controllers\SellController::class, 'send_invoice']), 'method' => 'post', 'id' => 'convert_sell_to_invoice_dian_form']) !!}
        ...
        <table class="table">
            ...
            <tbody>
              <tr>
                ...
                <td>{{$sell->status}}</td>
                <td>{{$sell->contact->email}}</td>
              </tr>
            </tbody>
        </table>

		<input type="hidden" name="prefix" value="{{$sell->prefix}}">
		<input type="hidden" name="number" value="{{$sell->number_invoice}}">

		<button type="submit" class="tw-dw-btn tw-dw-btn-success tw-dw-btn-sm tw-text-black">Reenviar correo</button>
