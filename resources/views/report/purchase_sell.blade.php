...
<section class="content">
    ...
    <div class="row no-print">
        ...
        <div class="col-md-2 col-xs-6">
            <div class="form-group pull-right">
                <div class="input-group">
                  <button type="button" class="tw-dw-btn tw-dw-btn-success tw-text-white tw-dw-btn-sm" id="purchase_sell_date_filter">
                    <span>
    ...
    <div class="row no-print">
        <div class="col-sm-12">
            <button class="tw-dw-btn tw-dw-btn-warning tw-text-black pull-right" aria-label="Print"
