...
<body>
  ...
  <script>
    ...
    // URL del video
    const youtubeURL = "https://www.youtube.com/embed/CiTCqP48EBw?si=lljflqHOslVACG4h"; // reemplaza con tu video
...
<section class="content">
    ...
    <div class="row no-print">
        ...
        <div class="col-md-2 col-xs-6">
            <div class="form-group pull-right">
                <div class="input-group">
                  <button type="button" class="tw-dw-btn bg-info tw-text-white tw-dw-btn-sm" id="purchase_sell_date_filter">
                    <span>
    ...
    <div class="row no-print">
        <div class="col-sm-12">
            <button class="tw-dw-btn bg-info tw-text-white pull-right" aria-label="Print"
