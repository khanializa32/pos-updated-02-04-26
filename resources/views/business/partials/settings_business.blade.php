    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::select('type_document_identification_id', $type_document_identifications, $business->type_document_identification_id, ['class' => 'form-control','placeholder' => 'Tipo de documento', 'required']); !!}
                </div>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    ...
                    {!! Form::text('nit', $business->nit, ['class' => 'form-control']); !!}
                </div>
            </div>
        </div>
        <div class="col-sm-1">
            <div class="form-group">
                ...
                <div class="input-group">
                    {!! Form::text('dv', $business->dv, ['class' => 'form-control']); !!}
                </div>
            </div>
        </div>
        <div class="col-sm-2">
            <div class="form-group">
                ...
                <div class="input-group">
                    {!! Form::text('merchant_registration', $business->merchant_registration, ['class' => 'form-control']); !!}
                </div>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::select('type_organization_id', $type_organizations, $business->type_organization_id, ['class' => 'form-control','placeholder' => 'Tipo de documento']); !!}
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::select('type_regime_id', $type_regimes, $business->type_regime_id, ['class' => 'form-control']); !!}
                </div>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::select('type_liability_id', $type_liabilities, $business->type_liability_id, ['class' => 'form-control']); !!}
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::select('department_id', $departments, $business->department_id, ['class' => 'form-control','id'=>'department_id']); !!}
                </div>
            </div>
        </div>
        <div class="col-sm-3">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    {!! Form::text('dian_token', $business->dian_token, ['class' => 'form-control']); !!}
                </div>
            </div>
        </div>
    </div>
