        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    ...
                    <input class="form-control" placeholder="" required name="identification_number" type="number" value="49786449" id="identification_number">
                </div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    ...
                    <input class="form-control" placeholder="Días de edición de transacción" required name="dv" type="number" value="4" id="dv">
                </div>
            </div>
        </div>
        <div class="clearfix"></div>
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <select class="form-control select2" required id="type_organization_id" name="type_organization_id"><option value="">Seleccione</option><option value="1">Persona Jurídica</option><option value="2" selected="selected">Persona Natural</option></select>
                </div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <select class="form-control select2" required id="type_regime_id" name="type_regime_id"><option value="">Seleccione</option><option value="1">Responsable de IVA</option><option value="2" selected="selected">No Responsable de IVA</option></select>
                </div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                <label for="type_liability_id">Tipo de Contribuyente:</label>
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-building"></i>
                    </span>
                    <select class="form-control select2" required id="type_liability_id" name="type_liability_id"><option value="">Seleccione</option><option value="7">Gran contribuyente</option><option value="9">Autorretenedor</option><option value="14">Agente de retención en el impuesto sobre las ventas</option><option value="112">Régimen Simple de Tributación – SIMPLE</option><option value="117" selected="selected">No responsable</option></select>
                </div>
            </div>
        </div>
