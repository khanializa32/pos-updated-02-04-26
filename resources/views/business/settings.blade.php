        ...
        @component('components.widget', ['class' =>  'pos-tab-container'])
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu tw-rounded-lg">
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-sm md:tw-text-base">@lang('lang_v1.modules_restobar')</a>
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                ...
                <!-- tab 13 end -->
                @include('business.partials.settings_dian')
                <!-- tab 14 end -->
                @include('business.partials.settings_social_security')
