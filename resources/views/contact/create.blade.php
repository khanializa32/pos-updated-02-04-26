        ...
        <div class="row">            
            ...
            <div class="col-md-8 business" style="display: none;">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::text('supplier_business_name', null, ['class' => 'form-control', 'id' => 'supplier_business_name', 'placeholder' => __('business.business_name')]); !!}
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    {!! Form::select('type_liability_id', $type_liabilities,117, ['class' => 'form-control', 'id' => 'type_liability_id']); !!}
                </div>
            </div>
