...
@section('title', 'Verificador de Precios')
...
@section('content')
    ...
    <div style="margin-bottom:8px;"> <img src="{{ asset('img/logo_abastos.png') }}" alt="Logo Empresa"style="max-height:190px; width:auto;"></div>
                ...
                <div style="display:flex; justify-content:center;">
                    ...
                    <input type="hidden" id="pl_location_id" value="{{ $location_id ?? '' }}">
                </div>
            </div>
        </div>
