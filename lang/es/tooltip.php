<?php
 ...
 return [
     'product_stock_alert' => "Productos con poco stock. <br/> <small class='text-muted'> Basado en la cantidad de alerta del producto establecida en la ficha del producto. Compre este producto antes de que el stock termine. </small>",
     ...
     'purchase_due' => 'Valor total no pagado por compras.', /* modified */
     'sell_due' => 'Cantidad total que se recibirá de las ventas',
     'over_all_sell_purchase' => '-ve value = Valor a pagar <br> + ve Valor = Valor a recibir',
     ...
     'top_trending_products' => "Los productos más vendidos de su tienda. <br/> <small class='text-muted'> aplique filtros para conocer los productos en tendencia para una categoría, marca, sucursal específica, etc. </small>",
     ...
     'invoice_layout' => "Diseño de facturas para su sucursal <small class='text-muted'> (<i> Puede agregar una nueva configuración de factura </ b> en <b> Configuración de factura <b> < /i>) </small> ",
     'invoice_scheme_name' => 'Dé un nombre breve y significativo al Esquema de factura',
     'invoice_scheme_prefix' => 'Prefijo para un esquema de factura. <br> Un prefijo puede ser un texto personalizado o un año actual. Ej .: # XXXX0001, # 2024-0002',
     ...
     'tax_groups' => 'Tasas de impuestos grupales - definidas anteriormente, para usar en combinación en las secciones Compra / Venta.',
     ...
     'all_location_permission' => 'Si <b> Todas las sucursales </ b> seleccionadas, esta función tendrá permiso para acceder a todas las sucursales',
     ...
     'tooltip_shipping' => 'Use esto para definir libremennte el valor de sus domicilios en cada pedido',
