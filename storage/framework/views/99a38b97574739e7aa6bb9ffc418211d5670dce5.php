    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    <?php echo Form::checkbox('pos_settings[activate_popup_agent_commission]', 1,  
                        !empty($pos_settings['activate_popup_agent_commission']) , 
                    [ 'class' => 'input-icheck']); ?> <?php echo e(__( 'lang_v1.activate_popup_agent_commission' ), false); ?>
...
</div><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/business/partials/settings_pos.blade.php ENDPATH**/ ?>