<div class="pos-tab-content">
    <div class="row">
        ...
        <!-- INICIO PARA LOS CAMPOS RETENCION EN VENTAS, BASE DE RETENCION Y TEXTO OBSERVACION EN FACTURAS -->
        
        <div class="col-sm-4">
            <div class="form-group">
                <label for="discount_retefunte">Porcentaje Retencion:*</label>
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-percent"></i>
                    </span>
                    <input class="form-control input_number" name="discount_retefuente" type="text" value="0.00">
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <label for="base_retefunte">Base Retencion:*</label>
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fas fa-money-bill-alt"></i>
                    </span>
                    <input class="form-control input_number" name="base_retefuente" type="text" value="0.00">
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <label for="text_sells">Texto Facturas Venta:</label> <i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                    data-content="Texto que se muestra en Observacion en todas las facturas de venta" data-html="true" data-trigger="hover"></i>                
                    <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fas fa-bars"></i>
                    </span>
                    <input class="form-control" name="text_sells" type="text" id="text_sells">
                </div>
            </div>
        </div>
        
               <!-- FIN  PARA LOS CAMPOS RETENCION EN VENTAS, BASE DE RETENCION Y TEXTO OBSERVACION EN FACTURAS --> 
    ...
    <div class="row">
        ...
        <div class="col-md-12"><h4><?php echo app('translator')->get('lang_v1.sale_delete_pin'); ?> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                    data-content="' . __('lang_v1.sale_delete_pin_link_help_text') . '" data-html="true" data-trigger="hover"></i>';
                }
                ?>:</h4></div>
        <div class="col-sm-2">
            <div class="form-group">
                    <?php echo Form::label('PIN DE SEGURIDAD'); ?>

                    <?php echo Form::text('sale_delete_pin', $business->sale_delete_pin , [ 'class' => 'form-control', 'id' => 'sale-delete-pin', 'required', 'minlength' => 4, 'maxlength' => 4,]); ?>
...
</div><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/business/partials/settings_sales.blade.php ENDPATH**/ ?>