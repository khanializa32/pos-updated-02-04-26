            ...
            <?php if($product->enable_stock == 1): ?>
                ...
                ?>
                                        ...
                                        <div class="total-stock-badge" 
                                             data-current-stock="<?php echo e($current_stock, false); ?>"
                                             data-row-count="<?php echo e($row_count, false); ?>"
                                            ...
                                            <span class="total-quantity" style="display: block; width: 100%; text-align: center; word-wrap: break-word; hyphens: auto;"><?php echo e(number_format($current_stock, session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?></span>
                                        </div>
                                    </div>
            <?php endif; ?>
...
<?php /**PATH C:\laragon\www\POS\alizazip\resources\views/purchase/partials/purchase_entry_row.blade.php ENDPATH**/ ?>