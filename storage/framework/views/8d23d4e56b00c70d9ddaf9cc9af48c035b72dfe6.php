...
<table class="table table-condensed">
    ...
    <?php $__empty_1 = true; $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <tr>
            <td><?php echo e(\Carbon::parse($activity->created_at)->format(session('business.date_format') . ' ' . 'H:i'), false); ?></td>
            <td>
...
<?php endif; ?><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/activity_log/activities.blade.php ENDPATH**/ ?>