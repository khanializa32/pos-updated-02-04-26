    ...
    <?php if($is_employee_allowed): ?>
        <div class="row">
            ...
            &nbsp;&nbsp;&nbsp;
                ...
                <?php if(!empty($clock_in)): ?>
                    <br>
                    <small class="text-muted"><?php echo app('translator')->get('essentials::lang.clocked_in_at'); ?>: <?php echo e(\Carbon::parse($clock_in->clock_in_time)->format(session('business.date_format') . ' ' . 'H:i'), false); ?></small>
                <?php endif; ?>
            </div>
        </div>
    <?php endif; ?>
                ...
                <div class="tab-content">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('essentials.crud_all_attendance')): ?>
                        <div class="tab-pane active" id="shifts_tab">
                            <button type="button" class="tw-dw-btn tw-bg--to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-black tw-border-none tw-rounded-full pull-right"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/Modules/Essentials/Providers/../Resources/views/attendance/index.blade.php ENDPATH**/ ?>