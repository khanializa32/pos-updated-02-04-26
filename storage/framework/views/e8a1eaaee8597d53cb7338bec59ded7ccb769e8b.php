...
<div class="modal-body">
    ...
    <div class="row">
      ...
      <div class="<?php if(!empty($export_custom_fields)): ?> col-sm-3 <?php else: ?> col-sm-4 <?php endif; ?>">
             ...
             <table class="table table-slim no-border">
               ...
               <?php $__currentLoopData = $sales_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $so): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  ...
                  <td><?php echo e(\Carbon::parse($so->transaction_date)->format(session('business.date_format') . ' ' . 'h:i A'), false); ?></td>
                </tr>
        ...
        <br>
        <?php if($sell->qrstr != ''): ?>
          <?php if(isset(explode("\n", $sell->qrstr)[9]) && explode("\n", $sell->qrstr)[9] != ''): ?>
            <a href="<?php echo e(explode("\n", $sell->qrstr)[9], false); ?>" target="_blank" class="badge text-bg-success" style="background-color: #41D78C; color: black;" rel="noopener noreferrer">Ver en la DIAN</a>
          <?php else: ?>
          <a href="<?php echo e($sell->qrstr, false); ?>" target="_blank" class="badge text-bg-success" style="background-color: #41D78C; color: black;" rel="noopener noreferrer">Ver en la DIAN</a>
          <?php endif; ?>
          
        <?php endif; ?>
        <?php if($sell->qrstr != ''): ?>
            <br/><a href="<?php echo e(route('downloadPdfInvoiceFE', [$sell->id]), false); ?>" target="_blank" class="badge text-bg-success" style="background-color: #E83B1A; color: white;" rel="noopener noreferrer"><i class="fas fa-download"></i> Descargar PDF</a>
        <?php endif; ?>
      </div>
      <div class="<?php if(!empty($export_custom_fields)): ?> col-sm-3 <?php else: ?> col-sm-4 <?php endif; ?>">
    ...
    <div><strong>Cufe: </strong>  <p><?php echo e($sell->cufe, false); ?></p></div>
    <?php
    ...
    <div>
      ...
      <?php if($let): ?>
        <?php $__currentLoopData = $let; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php if($sell->status_code == 0): ?>
          <span class="text-warning"><?php echo e($sell->status_code, false); ?>: <?php echo e($msg_data, false); ?></span><br/>
          <?php else: ?>
          <span class="text-danger"><?php echo e($sell->status_code, false); ?>: <?php echo e($msg_data, false); ?></span><br/>
          <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      <?php endif; ?>
    </div>
  ...
  <div class="modal-footer">
    <?php if($sell->type != 'sales_order'): ?>
    <a href="#" class="print-invoice tw-dw-btn bg-info tw-text-white tw-text-white" data-href="<?php echo e(route('sell.printInvoice', [$sell->id]), false); ?>?package_slip=true"><i class="fas fa-file-alt" aria-hidden="true"></i> <?php echo app('translator')->get("lang_v1.packing_slip"); ?></a>
    <?php endif; ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('print_invoice')): ?>
      <a href="#" class="print-invoice tw-dw-btn bg-info tw-text-white tw-text-white" data-href="<?php echo e(route('sell.printInvoice', [$sell->id]), false); ?>"><i class="fa fa-print" aria-hidden="true"></i> <?php echo app('translator')->get("lang_v1.print_invoice"); ?></a>
    <?php endif; ?>
...
<?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/sale_pos/show.blade.php ENDPATH**/ ?>