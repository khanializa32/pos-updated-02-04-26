<div class="modal-dialog modal-lg" role="document">
  ...
  ?>
    ...
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="z-index: 1053; position: relative;">
    ...
    <div class="modal-footer">
      ...
      <button type="button" class="tw-dw-btn tw-dw-btn-neutral tw-text-white" data-dismiss="modal" style="z-index: 1053; position: relative;"><?php echo app('translator')->get( 'messages.close' ); ?></button>
    </div>
...
<?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/contact/create.blade.php ENDPATH**/ ?>