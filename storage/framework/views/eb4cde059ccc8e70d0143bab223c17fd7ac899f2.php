    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="submit" class="tw-dw-btn bg-info tw-text-white"><?php echo app('translator')->get( 'messages.submit' ); ?></button>
...
</div><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/ledger_discount/create.blade.php ENDPATH**/ ?>