	...
	<div class="modal-dialog" role="document">
	  <div class="modal-content">
	    ...
	    <div class="modal-footer">
	      <button type="submit" class="tw-dw-btn bg-info tw-text-white tw-text-white"><?php echo app('translator')->get( 'essentials::lang.proceed' ); ?></button>
...
</div><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/Modules/Essentials/Providers/../Resources/views/payroll/payroll_modal.blade.php ENDPATH**/ ?>