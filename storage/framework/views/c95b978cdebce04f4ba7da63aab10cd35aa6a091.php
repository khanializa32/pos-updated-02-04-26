...
<table class="table table-bordered table-striped ajax_view hide-footer" id="product_table">
    <thead>
        <tr>
            ...
            <th class="tw-w-"><?php echo e(__('lang_v1.product_image'), false); ?> </th>
            <th><?php echo app('translator')->get('messages.action'); ?></th>
            <th><?php echo app('translator')->get('sale.product'); ?></th>
            <th><?php echo app('translator')->get('lang_v1.weight'); ?></th>
...
<?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/product/partials/product_list.blade.php ENDPATH**/ ?>