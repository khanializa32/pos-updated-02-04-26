...
<section class="content">
    ...
    <?php $__env->startComponent('components.widget', ['class' => 'box-primary']); ?>
      ...
      <hr>
        ...
        <div class="row">
        <div class="col-md-3">
          <h4><?php echo app('translator')->get( 'PRECIOS PARA ESTE USUARIO' ); ?></h4>
        </div>
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
        ...
        <div class="col-md-12 text-center">
           <button type="submit" class="tw-dw-btn tw-dw-btn bg-info tw-dw-btn-lg tw-text-white"><?php echo app('translator')->get( 'messages.update' ); ?></button>
        </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/role/edit.blade.php ENDPATH**/ ?>