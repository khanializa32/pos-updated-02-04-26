	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="tw-dw-btn tw-dw-btn-success tw-text-white" id="posEditDiscountModalUpdate"><?php echo app('translator')->get('Aplicar'); ?></button>
...
<?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/sale_pos/partials/edit_discount_modal.blade.php ENDPATH**/ ?>