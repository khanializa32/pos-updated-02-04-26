      ...
      <table class="table">
        ...
        <?php $__currentLoopData = $details['types_of_service_details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            ...
            <td>
              <span class="display_currency" data-currency_symbol="true">
                <?php echo e($detail->packing_charge, false); ?>
        ...
        <tr class="info">
          ...
          <th>
            <?php echo app('translator')->get('lang_v1.grand_total'); ?>:
            <span class="display_currency" data-currency_symbol="true">
              <?php echo e($totalPackingCharge, false); ?>
...
<?php endif; ?><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/cash_register/register_product_details.blade.php ENDPATH**/ ?>