							...
							<div class="small-box bg-purple">
					            <div class="inner text-center">
						            <?php if(!empty($sale->additional_notes)): ?>
						            	<p> <?php echo e($sale->additional_notes, false); ?></p>
						            <?php endif; ?>
					              ...
					              <p></i><?php echo app('translator')->get('Productos'); ?>: <?php echo e(count($sale->sell_lines), false); ?><br>
								...
								<?php if(auth()->user()->can('sell.update') || auth()->user()->can('direct_sell.update')): ?>
									...
									<?php echo app('translator')->get('Retomar'); ?> <i class="fa fa-angle-double-right"></i>
									</a>
								<?php endif; ?>
...
<?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/sale_pos/partials/suspended_sales_modal.blade.php ENDPATH**/ ?>