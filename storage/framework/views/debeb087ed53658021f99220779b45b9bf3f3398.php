	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="tw-dw-btn tw-dw-btn-success tw-text-white" id="weighing_scale_submit"><?php echo app('translator')->get('messages.submit'); ?></button>
...
</div><!-- /.modal --><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/sale_pos/partials/weighing_scale_modal.blade.php ENDPATH**/ ?>