...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black"><?php echo app('translator')->get('business.business_settings'); ?>
...
<?php echo Form::open(['url' => action([\App\Http\Controllers\BusinessController::class, 'postBusinessSettings']), 'method' => 'post', 'id' => 'bussiness_edit_form',
        ...
        <?php $__env->startComponent('components.widget', ['class' =>  'pos-tab-container']); ?>
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu tw-rounded-lg">
                ...
                ?></a>
                    ...
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-sm md:tw-text-base"><?php echo app('translator')->get('lang_v1.modules_restobar'); ?></a>
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                ...
                <!-- tab 13 end -->
                <?php echo $__env->make('business.partials.settings_dian', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <!-- tab 14 end -->
                <?php echo $__env->make('business.partials.settings_social_security', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="row">
        <div class="col-sm-12 text-center">
            <button class="tw-dw-btn bg-info tw-text-white" type="submit"><?php echo app('translator')->get('business.update_settings'); ?></button>
        </div>
    </div>
<?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/business/settings.blade.php ENDPATH**/ ?>