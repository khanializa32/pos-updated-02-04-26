<div class="row mini_print">
    <div class="col-sm-12">
        ...
        <?php if(!empty($self_consumption_transactions) && count($self_consumption_transactions) > 0): ?>
        <hr>
        ...
        <table class="table table-condensed table-striped">
            ...
            <tbody>
                <?php $__currentLoopData = $self_consumption_transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $self_consumption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($loop->iteration, false); ?></td>
                        <td><?php echo e($self_consumption->customer_name ?? 'Walk-In Customer', false); ?></td>
                        <td><?php echo e($self_consumption->invoice_no ?? 'N/A', false); ?></td>
                        <td class="text-right"><?php echo e(number_format($self_consumption->final_total ?? 0, session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
            <tfoot>
                <tr class="active">
                    <th colspan="3"><?php echo app('translator')->get('sale.total'); ?></th>
                    <th class="text-right"><?php echo e(number_format(collect($self_consumption_transactions)->sum('final_total'), session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?></th>
                </tr>
            </tfoot>
        </table>
        <?php endif; ?>
...
<?php echo $__env->make('cash_register.register_product_details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\POS\alizazip\resources\views/cash_register/payment_details.blade.php ENDPATH**/ ?>