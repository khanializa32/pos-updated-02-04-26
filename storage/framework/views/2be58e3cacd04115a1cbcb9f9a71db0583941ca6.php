...
<section class="content">
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                <?php echo Form::label('name', __('Nombre del Producto') . ':*'); ?>
       ...
       <!--<div class="col-sm-4">
        ...
        <div class="col-sm-4 <?php if(!session('business.enable_sub_units')): ?> hide <?php endif; ?>">
            <div class="form-group">
                ...
                <?php echo Form::select('sub_unit_ids[]', [], !empty($duplicate_product->sub_unit_ids) ? $duplicate_product->sub_unit_ids : null, ['class' => 'form-control select2', 'multiple', 'id' => 'sub_unit_ids', 'data-get-sub-units-url' => action([\App\Http\Controllers\ProductController::class, 'getSubUnits'])]); ?>
        ...
        <div class="col-sm-8">
            <div class="form-group">
                <?php echo Form::label('sub_unit_prices', __('lang_v1.sub_unit_prices') . ':'); ?>

                <div class="row" id="sub_unit_prices_wrapper">
                    <!-- Will be populated by JS when sub units are loaded -->
                </div>
                <small class="help-block"><?php echo app('translator')->get('lang_v1.enter_price_for_each_selected_unit'); ?></small>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="col-sm-2 <?php if(!session('business.enable_brand')): ?> hide <?php endif; ?>">
            <div class="form-group">
        ...
        <div class="col-sm-2 <?php if(!session('business.enable_category')): ?> hide <?php endif; ?>">
            <div class="form-group">
        ...
        <div class="col-sm-2 <?php if(!empty($duplicate_product) && $duplicate_product->enable_stock == 0): ?> hide <?php endif; ?>" id="alert_quantity_div">
            <div class="form-group">
        ...
        <div class="col-sm-2">
            <div class="form-group">
                ...
                <small>
                    <p class="help-block"><?php echo app('translator')->get('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)]); ?> <br> <?php echo app('translator')->get('lang_v1.aspect_ratio_should_be_1_1'); ?> .jpeg, .jpg, .gif, .png</p>
                </small>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-2 <?php if(!session('business.enable_price_tax')): ?> hide <?php endif; ?>">
            <div class="form-group">
        ...
        <div class="col-sm-2 <?php if(!session('business.enable_price_tax')): ?> hide <?php endif; ?>">
            <div class="form-group">
                ...
                <?php echo Form::select('tax_type', ['inclusive' => __('product.inclusive'), 'inclusive' => __('product.inclusive')], !empty($duplicate_product->tax_type) ? $duplicate_product->tax_type : 'inclusive',
        ...
        <div class="col-sm-12">
            ...
            <div class="text-center">
                <div class="btn-group">
                    ...
                    <button type="submit" value="submit_n_add_selling_prices" class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-lg tw-text-white submit_product_form"><?php echo app('translator')->get('lang_v1.save_n_add_selling_price_group_prices'); ?></button>
                    <?php endif; ?>
                    ...
                    <button type="submit" value="save_n_add_another" class="tw-dw-btn tw-dw-btn-lg bg-warning submit_product_form"><?php echo app('translator')->get('lang_v1.save_n_add_another'); ?></button>

                    <button type="submit" value="submit" class="tw-dw-btn tw-dw-btn-lg bg-info submit_product_form"><?php echo app('translator')->get('Crear Producto'); ?></button>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/product/create.blade.php ENDPATH**/ ?>