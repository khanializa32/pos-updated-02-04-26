...
<section class="content-header no-print">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black"><?php echo e(__('lang_v1.product_sell_report'), false); ?>
            ...
            <?php $__env->startComponent('components.filters', ['title' => __('report.filters')]); ?>
              ...
              <div class="col-md-4">
                    <div class="form-group">
                        <?php echo Form::label('invoice_scheme_id', __('Tipo de Factura').':'); ?>

                        <div class="input-group">
                            <?php echo Form::select('invoice_scheme_id', $invoice_schemes, null, ['class' => 'form-control select2', 'id' => 'invoice_scheme_id', 'placeholder' => __('Selecionar Tipo'), 'required']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/report/product_sell_report.blade.php ENDPATH**/ ?>