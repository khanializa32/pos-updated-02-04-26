	    ...
	    <div class="modal-content">
	    	<?php echo Form::open(['url' => action([\App\Http\Controllers\ProductController::class, 'updateProductLocation']), 'method' => 'post', 'id' => 'edit_product_location_form' ]); ?>
			    ...
			    <div class="modal-footer">
		      		<button type="submit" class="tw-dw-btn bg-info tw-text-white tw-text-white" id="update_product_location"><?php echo app('translator')->get( 'messages.save' ); ?></button>
...
</div><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/product/partials/edit_product_location_modal.blade.php ENDPATH**/ ?>