...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black"><?php echo e($title, false); ?>
     ...
     <div class="modal-dialog">
        <div class="modal-content" style="padding-bottom: 40px">
            ...
            <div class="modal-body">
                ...
                <p id="description-tutorial">Cree facturas a sus clientes</p>
		...
		<div class="form-group">
            ...
            <select name="select_location_id" id="select_location_id" class="form-control input-sm" required autofocus>
                <?php $__currentLoopData = $locOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($opt['value'], false); ?>" data-location-code="<?php echo e($opt['code'], false); ?>" <?php if(($default_location->id ?? null) == $opt['value']): ?> selected <?php endif; ?>><?php echo e($opt['label'], false); ?></option>
...
<input type="hidden" id="item_addition_method" value="<?php echo e($business_details->item_addition_method, false); ?>">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			<?php $__env->startComponent('components.widget', ['class' => 'box-solid']); ?>
				...
				<?php endif; ?>
				<div class="<?php if(!empty($commission_agent)): ?> col-sm-3 <?php else: ?> col-sm-2 <?php endif; ?>">
					<div class="form-group">
				...
				<?php if(!empty($status)): ?>
					...
					<?php endif; ?>
				<?php else: ?>
					<div class="<?php if(!empty($commission_agent)): ?> col-sm-2 <?php else: ?> col-sm-2 <?php endif; ?>">
						<div class="form-group">
				...
				<?php if($sale_type != 'sales_order'): ?>
					<div class="col-sm-2">
						<div class="form-group">
							...
							<?php echo Form::label('invoice_scheme_id', __('Resolución de Factura') . ':*'); ?>

							<?php echo Form::select('invoice_scheme_id', $invoice_schemes, $default_invoice_schemes->id, ['class' => 'form-control select2', 'required', 'placeholder' => __('messages.please_select')]); ?>
		        ...
		        <div class="col-sm-3">
	                <div class="form-group">
	                    <?php echo Form::label('upload_document', __('Adjuntar Documento') . ':'); ?>
					...
					<div class="form-group">
						<div class="input-group">
							<div class="input-group-btn">
								<button type="button" class="btn btn-default bg-white btn-flat" data-toggle="modal" data-target="#configure_search_modal" title="<?php echo e(__('lang_v1.configure_product_search'), false); ?>"><i class="glyphicon glyphicon-qrcode" style='font-size:16px;color:teal'></i></button>
							</div>
							...
							<span class="input-group-btn">
								<button type="button" class="btn btn-default bg-white btn-flat pos_add_quick_product" data-href="<?php echo e(action([\App\Http\Controllers\ProductController::class, 'quickAdd']), false); ?>" data-container=".quick_add_product_modal"><i class="fa fa-plus-circle text-danger fa-lg"></i></button>
							</span>
						</div>
					</div>
				</div>
	...
	<div class="row">
		...
		<div class="col-sm-12 text-center tw-mt-4">
			...
			<!-- <button type="button" id="save-and-print" class="tw-dw-btn tw-dw-btn-secondary tw-dw-btn-lg tw-text-white"><?php echo app('translator')->get('lang_v1.save_and_print'); ?></button>-->
		</div>
	</div>
		</br>	
	        ...
	        <div class="col-md-12 text-center">
				<button type="button" class="tw-dw-btn tw-dw-btn-light tw-dw-btn-sm tw-text-black" id="toggle_additional_expense"> <i class="fas fa-plus"></i> <?php echo app('translator')->get('lang_v1.add_additional_expenses'); ?> <i class="fas fa-chevron-down"></i></button>
			</div>
	...
	<div class="row">
		...
		<div class="col-sm-12 text-center tw-mt-4">
			<button type="button" id="submit-sell" class="tw-dw-btn bg-info tw-text-white"><?php echo app('translator')->get('Generar Documento'); ?></button>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/sell/create.blade.php ENDPATH**/ ?>