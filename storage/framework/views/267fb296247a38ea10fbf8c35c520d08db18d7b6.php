...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black"><?php echo app('translator')->get('purchase.add_purchase'); ?> <i class="fa fa-keyboard-o hover-q text-muted" aria-hidden="true" data-container="body" data-toggle="popover" data-placement="bottom" data-content="<?php echo $__env->make('purchase.partials.keyboard_shortcuts_details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>" data-html="true" data-trigger="hover" data-original-title="" title=""></i>
...
<section class="content">
	...
	<?php $__env->startComponent('components.widget', ['class' => 'box-info']); ?>
		<div class="row">
			<div class="<?php if(!empty($default_purchase_status)): ?> col-sm-3 <?php else: ?> col-sm-3 <?php endif; ?>">
			...
			<div class="col-sm-2">
				<div class="form-group">
					<?php echo Form::label('location_id', __('Bodega / Sucursal').':*'); ?>
			...
			<div class="<?php if(!empty($default_purchase_status)): ?> col-sm-2 <?php else: ?> col-sm-3 <?php endif; ?>">
				<div class="form-group">
			...
			<div class="<?php if(!empty($default_purchase_status)): ?> col-sm-2 <?php else: ?> col-sm-3 <?php endif; ?>">
				<div class="form-group">
					...
					<div class="input-group">
						...
						<?php echo Form::text('transaction_date', \Carbon::parse('now')->format(session('business.date_format') . ' ' . 'H:i'), ['class' => 'form-control', 'readonly', 'required']); ?>
			...
			<div class="col-md-2">
                ...
                ?>
		              <br/>
		              <?php echo Form::number('pay_term_number', null, ['class' => 'form-control width-40 pull-left', 'min' => 0, 'placeholder' => __('contact.pay_term')]); ?>
			...
			<div class="col-sm-3">
                <div class="form-group">
                    ...
                    <p class="help-block">
                    	<?php echo app('translator')->get('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)]); ?> pdf, .csv, .zip, .doc,  .jpg
			...
			<div class="col-sm-4">
				<div class="form-group">
					<?php echo Form::label('cufe', __('Cufe').':'); ?>

					<?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                    data-content="' . __('Cufe de la factura de compra') . '" data-html="true" data-trigger="hover"></i>';
                }
                ?>
					<?php echo Form::text('cufe', null, ['class' => 'form-control']); ?>
	...
	<?php $__env->startComponent('components.widget', ['class' => 'box-info']); ?>
		<div class="row">
			<div class="col-sm-2 text-center">
				<button type="button" class="tw-dw-btn tw-dw-btn-purple tw-text-black tw-dw-btn-sm" data-toggle="modal" data-target="#import_purchase_products_modal"><?php echo app('translator')->get('product.import_products'); ?></button>
			</div>
			<div class="col-sm-8">
				<div class="form-group">
					<div class="input-group">
			...
			<div class="col-sm-2">
				<div class="form-group">
					<button tabindex="-1" type="button" class="tw-dw-btn bg-info tw-text-white btn-modal"data-href="<?php echo e(action([\App\Http\Controllers\ProductController::class, 'quickAdd']), false); ?>" 
	...
	<?php $__env->startComponent('components.widget', ['class' => 'box-info']); ?>
		...
		<div class="row">
				<div class="col-sm-12 text-center">
					<button type="button" id="submit_purchase_form" class="tw-dw-btn bg-info tw-text-white"><?php echo app('translator')->get('Guardar Compra'); ?></button>
				</div>
			</div>
	...
	<div class="row">
		...
		<div class="row">
			<div class="col-md-12 text-center">
				<button type="button" class="tw-dw-btn tw-dw-btn-ligth tw-text-black tw-dw-btn-sm" id="toggle_additional_expense"> <i class="fas fa-plus"></i> <?php echo app('translator')->get('lang_v1.add_additional_expenses'); ?> <i class="fas fa-chevron-down"></i></button>
			</div>
	...
	<?php echo $__env->renderComponent(); ?>
	<?php $__env->startComponent('components.widget', ['class' => 'box-info', 'title' => __('purchase.add_payment')]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\POS\alizazip\resources\views/purchase/create.blade.php ENDPATH**/ ?>