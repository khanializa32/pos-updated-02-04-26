...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="col-md-2 text-right">
            <button data-href="<?php echo e(action([\App\Http\Controllers\ContactController::class, 'getLedger']), false); ?>?contact_id=<?php echo e($contact->id, false); ?>&action=pdf" class="btn btn-default btn-xs" id="print_ledger_pdf" style="font-size:20px ;color:crimson"><i class="fas fa-file-pdf"></i></button>&nbsp;&nbsp;
...
<?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/contact/partials/ledger_tab.blade.php ENDPATH**/ ?>