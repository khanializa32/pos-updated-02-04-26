<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            <?php echo Form::label('tax_type', __('product.selling_price_tax_type') . ':*'); ?>
              ...
              <?php echo Form::select('tax_type', ['inclusive' => __('product.inclusive'), 'exclusive' => __('product.exclusive')], 'inclusive',
    ...
    <div class="modal-footer">
      <button type="submit" class="tw-dw-btn bg-info tw-text-white" id="submit_quick_product"><?php echo app('translator')->get( 'Crear Producto' ); ?></button>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    if (typeof window.toggle_dsp_input === 'undefined') {
      $.getScript("<?php echo e(asset('js/product.js?v=' . $asset_v), false); ?>");
    }
...
<?php /**PATH C:\laragon\www\POS\alizazip\resources\views/product/partials/quick_add_product.blade.php ENDPATH**/ ?>