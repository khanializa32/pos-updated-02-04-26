...
<table class="table <?php if(!empty($for_ledger)): ?> table-slim mb-0 bg-light-white <?php else: ?> bg-gray <?php endif; ?>" <?php if(!empty($for_pdf)): ?> style="width: 100%;" <?php endif; ?>>
        <tr <?php if(empty($for_ledger)): ?> class="bg-info tw-text-white" <?php endif; ?>>
        <th>#</th>
        ...
        <?php endif; ?>
        <th><?php echo e(__('Base'), false); ?></th>
    ...
    <?php $__currentLoopData = $sell->sell_lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sell_line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php endif; ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</table><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/sale_pos/partials/sale_line_details.blade.php ENDPATH**/ ?>