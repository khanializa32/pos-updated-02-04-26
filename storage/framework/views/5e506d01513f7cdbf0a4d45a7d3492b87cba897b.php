<div class="modal fade" id="credit_payment_modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <?php echo Form::open(['url' => action([\App\Http\Controllers\LoanController::class, 'store']), 'contact' => $contact->id]); ?>
            ...
            <div class="modal-body">
                <div class="form-group">
                    <?php echo Form::label('amount', __( 'sale.amount' ) . ':*'); ?>
                      ...
                      <?php echo Form::text('amount', null, ['class' => 'form-control input_number sum_credits', 'required', 'placeholder' => __( 'sale.amount' ) ]); ?>
...
</div><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/contact/partials/payment_credits.blade.php ENDPATH**/ ?>