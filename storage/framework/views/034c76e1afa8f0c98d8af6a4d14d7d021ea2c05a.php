    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- Include filter for products according to rack -->
                
                                   <?php if($rack_enabled): ?>
                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo Form::label('rack_filter', __('Estante') . ':'); ?>
                ...
                <!-- End Include filter for products according to rack -->
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <br>
                            <label>
                                <?php echo Form::checkbox('nonzero_quantity', 1, false, ['class' => 'input-icheck', 'id' => 'nonzero_quantity']); ?> <strong>No Mostrar Cantidades 0</strong>
                            </label>
                        </div>
                    </div>
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a href="#product_list_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-cubes" style=" font-size:24px ;color:orange"
                                        aria-hidden="true"></i> <?php echo app('translator')->get('Mis Productos'); ?></a>
                            </li>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('stock_report.view')): ?>
                                <li>
                                    <a href="#product_stock_report" class="product_stock_report" data-toggle="tab"
                                     ...
                                     <?php echo app('translator')->get('Valor del Inventario'); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                                ...
                                <?php endif; ?>
								 ...
								 <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product.create')): ?>
                                    ...
                                    <a class="tw-dw-btn tw-bg--to-r tw-from-600 tw-to-blue-500 tw-font-bold tw-text-black tw-border-none tw-full pull-right tw-m-2"
                                        href="<?php echo e(action([\App\Http\Controllers\SellingPriceGroupController::class, 'updateProductPrice']), false); ?>">
                                        <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="green"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-file-excel"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2" /><path d="M10 12l4 5" /><path d="M10 17l4 -5" /></svg> <?php echo app('translator')->get('Actualizar Precios'); ?>
                                    </a>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product.create')): ?>
                                    ...
                                    <a class="tw-dw-btn tw-bg--to-r tw-from-600 tw-to-blue-500 tw-font-bold tw-text-black tw-border-none tw-full pull-right tw-m-2"
                                        ...
                                        viewBox="0 0 20 20" fill="none" stroke="teal" stroke-width="3" stroke-linecap="round"
                                            ...
                                            <path d="M12 5l0 14" />
                                            <path d="M5 12l14 0" />
                                        </svg> <?php echo app('translator')->get('Crear Producto'); ?>
                                    </a>
                                    <br><br>
                                <?php endif; ?>
        ...
        <div class="modal fade" id="edit_rack_details_modal" tabindex="-1" role="dialog"
            aria-labelledby="gridSystemModalLabel">
        </div>
...
<?php $__env->startSection('javascript'); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            product_table = $('#product_table').DataTable({
                ...
                "ajax": {
                    ...
                    "data": function(d) {
                        ...
                        d.nonzero_quantity = $('#nonzero_quantity').is(':checked');

                        d.location_id = $('#location_id').val();
                        d.rack = $('#rack_filter').val();
            ...
            // Edit rack details
            $(document).on('click', 'a.edit-rack-details', function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        $('#edit_rack_details_modal').html(result).modal('show');
                    }
                });
            });

            // Submit rack details form
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if (result.success) {
                            ...
                            $('#edit_rack_details_modal').modal('hide');
                            product_table.ajax.reload();
                        } else {
            ...
            $(document).on('change',
                '#product_list_filter_type, #product_list_filter_category_id, #product_list_filter_brand_id, #product_list_filter_unit_id, #product_list_filter_tax_id, #location_id, #active_state, #repair_model_id, #rack_filter',
                function() {
            ...
            $(document).on('ifChanged', '#not_for_selling, #nonzero_quantity, #woocommerce_enabled', function() {
                if ($("#product_list_tab").hasClass('active')) {
                    product_table.ajax.reload();
                }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/product/index.blade.php ENDPATH**/ ?>