...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black"><?php echo app('translator')->get( 'accounting::lang.chart_of_accounts' ); ?></h1>
</section>
                    ...
                    <a class="tw-dw-btn tw-bg--to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-black tw-border-none tw-rounded-full btn-modal"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26"
                                        viewBox="0 0 20 20" fill="none" stroke="teal" stroke-width="3" stroke-linecap="round"
                                            ...
                                            <path d="M12 5l0 14" />
                                            <path d="M5 12l14 0" />
                                        </svg> <?php echo app('translator')->get( 'accounting::lang.add_chart_account' ); ?>
                    </a>
                    
                    <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-green-600 tw-to-teal-500 tw-font-bold tw-text-black tw-border-none tw-rounded-full"
                        <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-green-600 tw-to-teal-500 tw-font-bold tw-text-black tw-border-none tw-rounded-full"
                        href="<?php echo e(route('accounting.import-puc'), false); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26"
                                        viewBox="0 0 20 20" fill="none" stroke="teal" stroke-width="3" stroke-linecap="round"
                                            stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-plus">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/Modules/Accounting/Providers/../Resources/views/chart_of_accounts/index.blade.php ENDPATH**/ ?>