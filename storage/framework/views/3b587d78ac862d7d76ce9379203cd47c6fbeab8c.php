		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-6">
				        <div class="form-group">
				            <?php echo Form::label('delivery_person_modal', __('Domiciliario') . ':' ); ?> <br>
			...
			<div class="modal-footer">
				<button type="button" class="tw-dw-btn bg-info tw-text-white tw-text-white" id="posShippingModalUpdate"><?php echo app('translator')->get('Cargar Domicilio'); ?></button>
...
<?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/sale_pos/partials/edit_shipping_modal.blade.php ENDPATH**/ ?>