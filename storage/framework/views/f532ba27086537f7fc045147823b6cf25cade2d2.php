           ...
           <div class="col-sm-4">
            ...
            <div class="col-sm-4 <?php if(!session('business.enable_sub_units')): ?> hide <?php endif; ?>">
              <div class="form-group">
                ...
                <select name="sub_unit_ids[]" class="form-control select2" multiple id="sub_unit_ids" data-get-sub-units-url="<?php echo e(action([\App\Http\Controllers\ProductController::class, 'getSubUnits']), false); ?>">
              ...
              <div class="form-group">
                <?php echo Form::label('sub_unit_prices', __('lang_v1.sub_unit_prices') . ':'); ?>
                 ...
                 ?>
                      ...
                      data-prices='<?php echo json_encode($existing_purchase_prices, 15, 512) ?>'
                      data-sell-prices='<?php echo json_encode($existing_sell_prices, 15, 512) ?>'
                      data-margins='<?php echo json_encode($existing_margins, 15, 512) ?>'></div>
                ...
                <?php echo Form::label('rack_' . $id,  $location . ':'); ?>
                  ...
                  <?php if(!empty($rack_details[$id])): ?>
                    <?php if(session('business.enable_racks')): ?>
                      <?php echo Form::text('product_racks_update[' . $id . '][rack]', $rack_details[$id]['rack'], ['class' => 'form-control', 'id' => 'rack_' . $id,'placeholder' => __('lang_v1.rack')]); ?>

                <?php endif; ?>
 <br>
                    <?php if(session('business.enable_row')): ?>
                      <?php echo Form::text('product_racks_update[' . $id . '][row]', $rack_details[$id]['row'], ['class' => 'form-control','placeholder' => __('lang_v1.row')]); ?>

                <?php endif; ?>
 <br>
                    <?php if(session('business.enable_position')): ?>
                      <?php echo Form::text('product_racks_update[' . $id . '][position]', $rack_details[$id]['position'], ['class' => 'form-control','placeholder' => __('lang_v1.position')]); ?>
        ...
        <div class="col-sm-12">
          <div class="text-center">
            <div class="btn-group">
              ...
              <button type="submit" value="submit" class="tw-dw-btn bg-info tw-text-white tw-dw-btn-lg submit_product_form"><?php echo app('translator')->get('messages.update'); ?></button>
            </div>
          </div>
        </div>
  </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/product/edit.blade.php ENDPATH**/ ?>