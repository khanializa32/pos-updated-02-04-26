        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs nav-justified">
                    <li class="
                            ...
                            <?php else: ?>
                                ''
                            <?php endif; ?>">
                        <a href="#ledger_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-scroll" style="font-size:24px ;color:ForestGreen" aria-hidden="true"></i> <?php echo app('translator')->get('lang_v1.ledger'); ?></a>
                    </li>
                    <!--<li
                            class="
                            <?php if(!empty($view_type) && $view_type == 'loans'): ?> active
                            <?php else: ?>
                                '' <?php endif; ?>">
                            <a href="#loans_tab" class="credit_index_btn" data-toggle="tab" data-url="<?php echo e(route('loans.show', $contact->id), false); ?>" aria-expanded="true"><i class="fas fa-solid fa-credit-card" style="font-size:24px ;color:DodgerBlue"></i> Creditos</a>
                        </li> -->
                    <?php if(in_array($contact->type, ['both', 'supplier'])): ?>
                        <li class="
                            ...
                            <?php else: ?>
                                ''
                            <?php endif; ?>">
                            <a href="#purchases_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-arrow-circle-down" style="font-size:24px ;color:FireBrick" aria-hidden="true"></i> <?php echo app('translator')->get( 'purchase.purchases'); ?></a>
                        </li>
                        <li class="
                            ...
                            <?php else: ?>
                                ''
                            <?php endif; ?>">
                            <a href="#stock_report_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-hourglass-half" style="font-size:24px ;color:DarkViolet"  aria-hidden="true"></i> <?php echo app('translator')->get( 'report.stock_report'); ?></a>
                        </li>
                    <?php endif; ?>
                    <?php if(in_array($contact->type, ['both', 'customer'])): ?>
                        <li class="
                            ...
                            <?php else: ?>
                                ''
                            <?php endif; ?>">
                            <a href="#sales_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-file" style="font-size:24px ;color:DarkOrange" aria-hidden="true"></i> <?php echo app('translator')->get( 'Facturas'); ?></a>
                        </li>
                    ...
                    <!--<li class="
                            ...
                            <?php endif; ?>
                            ">
                        <a href="#documents_and_notes_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-paperclip" style="font-size:24px ;color:DeepPink" aria-hidden="true"></i> <?php echo app('translator')->get('lang_v1.documents_and_notes'); ?></a>
                    </li> -->
                    <li class="
                            ...
                            <?php else: ?>
                                ''
                            <?php endif; ?>">
                        <a href="#payments_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-money-bill-alt" style="font-size:24px ;color:LimeGreen" aria-hidden="true"></i> <?php echo app('translator')->get('sale.payments'); ?></a>
                    </li>
                    ...
                    <?php if( in_array($contact->type, ['customer', 'both']) && session('business.enable_rp')): ?>
                        <li class="
                            ...
                            <?php else: ?>
                                ''
                            <?php endif; ?>">
                            <a href="#reward_point_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-gift" style="font-size:24px ;color:tomato" aria-hidden="true"></i> <?php echo e(session('business.rp_name') ?? __( 'lang_v1.reward_points'), false); ?></a>
                        </li>
                    <?php endif; ?>
                    ...
                    <!--<li class="
                        ...
                        <?php else: ?>
                            ''
                        <?php endif; ?>">
                        <a href="#activities_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-pen-square" style="font-size:25px ;color:BlueViolet" aria-hidden="true"></i> <?php echo app('translator')->get('lang_v1.activities'); ?></a>
                        </li> -->
                ...
                <div class="tab-content">
                    <div class="tab-pane
                                <?php if(!empty($view_type) && $view_type == 'ledger'): ?> active
                                <?php else: ?>
                                    '' <?php endif; ?>"
                            id="ledger_tab">
                        ...
                        <div class="tab-pane
                                ...
                                <?php else: ?>
                                    '' <?php endif; ?>"
                            id="loans_tab">
                            <?php echo $__env->make('contact.partials.loans_tab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    <?php if(in_array($contact->type, ['both', 'supplier'])): ?>
                        <div class="tab-pane
                            <?php if(!empty($view_type) &&  $view_type == 'purchase'): ?>
...
<?php echo $__env->make('contact.partials.add_payment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('contact.partials.index_credits', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('contact.partials.payment_credits', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('contact.partials.create_credits', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('contact.partials.edit_credits', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.status == true) {
                            ...
                            $(".loanPayment").remove();
                            data.loans.forEach(function(loanData) {
                                loan.removeAttr("id").removeClass("hide").addClass("loanPayment");
                                loan.find(".id_loan").text(loanData.id);
                                loan.find(".amount_loan").text(loanData.amount);
                                loan.find(".date_loan").text(loanData.created_at);
                                loanList.append(loan
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/contact/show.blade.php ENDPATH**/ ?>