    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header text-center" style="background-color:#004C6E;color:#EDAF11;font-size: 30px;">
                <?php echo app('translator')->get("inventorymanagement::inventory.products_reports_increase"); ?>
            </div>
        </div>
        <div class="box-body">
            <div class="row">
                <div class="col-sm-12">
                 ...
                 <div style="margin-top: 10px;">
                    <strong><?php echo app('translator')->get("inventorymanagement::inventory.total_increase"); ?>:</strong>
                    <span class="display_currency" data-currency_symbol="true" style="font-size:36px;color:green;">
                        <?php echo e($increaseProductReport->sum(function($item){ return $item->pivot->total ?? 0; }), false); ?>
        ...
        <table id="example1" class="display nowrap" style="width:100%">
            ...
            <tbody>
            <?php echo $__env->make("inventorymanagement::partials.increaseReports", ['increaseProductReport' => $increaseProductReport, 'variations' => $variations], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </tbody>
...
<?php $__env->startSection('javascript'); ?>
    ...
    function fallbackExcelExport() {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, 'Increase Report');
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/Modules/InventoryManagement/Providers/../Resources/views/increaseReports.blade.php ENDPATH**/ ?>