        ...
        <div class="row">
            <div class="col-1 col-sm-offset-11">
                <a href="javascript:" data-target="#credit_create_modal" data-toggle="modal"
                    ...
                    data-url="<?php echo e(route('loans.create', $contact->id), false); ?>"><i
...
<?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/contact/partials/loans_tab.blade.php ENDPATH**/ ?>