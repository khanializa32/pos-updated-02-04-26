    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="tw-dw-btn tw-dw-btn-neutral tw-text-white" data-dismiss="modal">Regresar</button>
                <button type="submit" class="tw-dw-btn bg-info tw-text-white tw-text-white" id="pos-save"><?php echo app('translator')->get('Cobrar Venta'); ?></button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="card_details_modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="tw-dw-btn bg-info tw-text-white tw-text-white" id="pos-save-card"><?php echo app('translator')->get('sale.finalize_payment'); ?></button>
            </div>
        </div>
    </div>
</div>

<?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/sale_pos/partials/payment_modal.blade.php ENDPATH**/ ?>