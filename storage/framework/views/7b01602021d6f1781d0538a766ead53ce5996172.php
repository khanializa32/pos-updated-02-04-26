<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <?php echo Form::open(['url' => action([\App\Http\Controllers\TransactionPaymentController::class, 'postPayContactDue'], [$contact_details->id]), 'method' => 'post', 'id' => 'pay_contact_due_form', 'files' => true ]); ?>
    ...
    <input type="hidden" id="default_payment_accounts" value="<?php echo e($default_payment_accounts, false); ?>">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <?php echo Form::text('paid_on', \Carbon::parse($payment_line->paid_on)->format(session('business.date_format') . ' ' . 'H:i'), ['class' => 'form-control', 'readonly', 'required']); ?>
...
<?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/transaction_payment/pay_supplier_due_modal.blade.php ENDPATH**/ ?>