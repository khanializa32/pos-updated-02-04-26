	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="tw-dw-btn bg-info tw-text-white tw-text-white" id="posEditOrderTaxModalUpdate"><?php echo app('translator')->get('Aplicar'); ?></button>
...
<?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/sale_pos/partials/edit_order_tax_modal.blade.php ENDPATH**/ ?>