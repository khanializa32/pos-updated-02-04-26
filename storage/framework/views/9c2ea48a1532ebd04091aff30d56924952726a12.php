...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black"><?php echo e(__('report.stock_report'), false); ?>
        ...
        <div class="col-md-12">
            <?php $__env->startComponent('components.filters', ['title' => __('report.filters')]); ?>
              <?php echo Form::open(['url' => action([\App\Http\Controllers\ReportController::class, 'getStockReport']), 'method' => 'get', 'id' => 'stock_report_filter_form' ]); ?>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <?php echo Form::label('stock_date', 'Fecha corte:'); ?>

                        <?php echo Form::text('stock_date', null, ['class' => 'form-control', 'id' => 'stock_date', 'readonly', 'placeholder' => __('Seleccione una fecha')]); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table no-border">
                <tr>
                    <td><?php echo app('translator')->get('report.my_closing_stock'); ?> (<?php echo app('translator')->get('lang_v1.my_purchase_price'); ?>)</td>
                    <td><?php echo app('translator')->get('report.my_closing_stock'); ?> (<?php echo app('translator')->get('lang_v1.my_purchase_price'); ?>)</td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/report/stock_report.blade.php ENDPATH**/ ?>