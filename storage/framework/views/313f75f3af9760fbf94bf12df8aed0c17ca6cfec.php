   ...
   <div class="col-sm-3">
      ...
      <div class="col-md-2 hide service_staff_pin_div">
        <div class="form-group">
          <?php echo Form::label('service_staff_pin', __( 'lang_v1.staff_pin' ) . ':'); ?>
            ...
            <?php echo Form::password('service_staff_pin', ['class' => 'form-control', '' => true, 'placeholder' => __( 'lang_v1.staff_pin' ) ]); ?>
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <button type="submit" class="tw-dw-btn bg-info tw-text-white" id="submit_user_button"><?php echo app('translator')->get( 'messages.update' ); ?></button>
        </div>
    </div>
    <?php echo Form::close(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/manage_user/edit.blade.php ENDPATH**/ ?>