	...
	$(document).on('click', '.btn-modal', function (e) {
		...
		$.ajax({
			...
			error: function(xhr, status, error) {
				console.error('Modal load error:', status, error, xhr.responseText);
				toastr.error('خرابی: ڈیٹا لوڈ نہیں ہو سکا');
			}
		});
	});
...
</script><?php /**PATH C:\laragon\www\POS\alizazip\Modules\Manufacturing\Providers/../Resources/views/layouts/partials/common_script.blade.php ENDPATH**/ ?>