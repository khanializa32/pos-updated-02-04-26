<div class="row">
	...
	<div class="<?php echo e($col_class, false); ?>">
		<div class="form-group">
			...
			<div class="input-group">
              ...
              <?php echo Form::text("payment[$row_index][paid_on]", isset($payment_line['paid_on']) ? \Carbon::parse($payment_line['paid_on'])->format(session('business.date_format') . ' ' . 'H:i') : \Carbon::parse('now')->format(session('business.date_format') . ' ' . 'H:i'), ['class' => 'form-control paid_on', 'readonly', 'required']); ?>
	...
	<div class="col-md-12">
		<div class="form-group">
			...
			<?php echo Form::textarea("payment[$row_index][note]", $payment_line['note'], ['class' => 'form-control', 'rows' => 2, 'id' => "note_$row_index"]); ?>

		</div>
	</div>
</div>
<?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/sale_pos/partials/payment_row_form.blade.php ENDPATH**/ ?>