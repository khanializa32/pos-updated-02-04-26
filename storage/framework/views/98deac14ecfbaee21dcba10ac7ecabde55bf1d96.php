    ...
    <table class="table table-bordered add-product-price-table table-condensed <?php echo e($class, false); ?>">
        ...
        <tr>
          <td>
              ...
              <?php echo Form::label('single_dpp_inc_tax', trans('product.purchase__price' ) . ':*'); ?>
            ...
            <div class="col-sm-6" style="font-size:16px ;color:gray">
          ...
          <td>
            <label><span class="dsp_label"  style="font-size:16px ;color:green"><?php echo app('translator')->get('product.sale_price'); ?></span></label>
...
<?php /**PATH /home/u371716713/domains/ziscoplus.com/public_html/alizazip/resources/views/product/partials/single_product_form_part.blade.php ENDPATH**/ ?>