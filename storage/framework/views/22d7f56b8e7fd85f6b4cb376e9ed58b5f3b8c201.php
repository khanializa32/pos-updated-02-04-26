...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black" ><?php echo app('translator')->get('manufacturing::lang.add_ingredients'); ?></h1>
</section>
...
<section class="content">
	...
	<div class="box box-solid">
		...
		<div class="box-body">
			<div class="row">
				<div class="col-md-12">
					<button type="button" class="tw-dw-btn tw-dw-btn-success tw-text-white pull-right" id="add_ingredient_group"><?php echo app('translator')->get('manufacturing::lang.add_ingredient_group'); ?> <?php
	...
	<div class="box box-solid">
		<div class="box-body">
			...
			<div class="row">
				<div class="col-sm-12">
					<button type="submit" class="tw-dw-btn bg-info tw-text-white pull-right"><?php echo app('translator')->get('messages.save'); ?></button>
				</div>
			</div>
		</div>
	</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\POS\alizazip\Modules\Manufacturing\Providers/../Resources/views/recipe/add_ingredients.blade.php ENDPATH**/ ?>